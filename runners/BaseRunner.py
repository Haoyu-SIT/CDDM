        ...
        try:
            ...
            for epoch in range(start_epoch, self.config.training.n_epochs):
                ...
                for train_batch in pbar:
                    ...
                    with torch.no_grad():
                        if self.global_step % 1 == 0:#validation numbers
    ...
    def test(self):
        ...
        if self.config.training.use_DDP:
            ...
            test_loader = DataLoader(test_dataset,
                                    ...
                                    shuffle=False,
                                    num_workers=0,
                                    drop_last=False)  # Ensure drop_last=False for all cases
        ...
        if self.config.args.sample_to_eval:
            ...
            for test_batch in test_loader:  # Correct iteration over test_loader
                sample_path = os.path.join(self.config.result.sample_path, "test_sample")
                if self.config.training.use_DDP:
